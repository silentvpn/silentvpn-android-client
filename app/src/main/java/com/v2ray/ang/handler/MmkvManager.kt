...
object MmkvManager {
    ...
    // ... အခြား key များ
    // 🔥 ဒီ Key တွေ ထပ်ဖြည့်ပေးပါ
    private const val PREF_PER_APP_PROXY = "per_app_proxy" // Split Tunnel ဖွင့်/ပိတ်
    private const val PREF_PER_APP_PROXY_SET = "per_app_proxy_set" // ရွေးထားတဲ့ App စာရင်း
